...
export const courseMeta = slopCourseMetaSchema.parse({
  code: "SLOP2282",
  title: "Learning Korean Culture with 12 Korean Dramas",
  session: "Semester 1",
  year: 2027,
  level: 2,
  ...
  endDate: "2027-05-28",
  description:
    "A weekly seminar using twelve Korean television dramas, from royal-court " +
    "melodrama to barracks comedy, as primary sources for studying Korean " +
    "history, society and popular culture, and for practising the difference " +
    "between what a drama shows and what it dramatises.",
  tags: ["Korean Studies", "K-Drama", "Popular Culture"],
